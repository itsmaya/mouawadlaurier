                  ...
                  folderNames.map(function(f){
                    ...
                    return e("div",{key:f,style:{marginBottom:12}},
                      e("div",{style:{display:"flex",alignItems:"center",gap:8,
                        ...
                        /* Bouton JSON du dossier */
                        e("button",{onClick:function(ev){
                            ev.stopPropagation();
                            store.exportJsonFolder(f);},
                            title:"Exporter ce dossier en .json",
                            style:{fontSize:11,border:"1px solid #ddd",borderRadius:5,
                              padding:"3px 9px",cursor:"pointer",background:"#f5f5f5",
                              color:"#555",fontWeight:700,fontFamily:"inherit"}},
                          "{ } JSON"),
                        /* Bouton ZIP */
                        props.doExportOne
                          ? e("button",{onClick:function(ev){
